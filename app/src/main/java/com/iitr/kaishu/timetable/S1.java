...
contentView.setTextColor(id, Color.BLACK);
        ...
        contentView.setTextViewText(R.id.batch, "TimeTable (Economics)");

        hhhhh();

        Intent intenttr = new Intent(S1.this, TimeTable.class);
        intenttr.setAction("android.appwidget.action.APPWIDGET_UPDATE");
        int idskk[] = AppWidgetManager.getInstance(getApplication()).getAppWidgetIds(new ComponentName(getApplication(), TimeTable.class));
...
Boolean yes=true ;
    ...
    public void hhhhh() {
        ...
        Intent v99 = new Intent("99");PendingIntent g99 = PendingIntent.getBroadcast(this, 0, v99, 0);contentView.setOnClickPendingIntent(R.id.imageButton, g99);
