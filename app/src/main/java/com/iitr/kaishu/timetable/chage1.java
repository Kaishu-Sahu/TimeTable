...
public class chage1 extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        String where[]={gotitt};
        Cursor getcsg = getghg.query("S2", nameddd, "id=?",where, null, null, null);
                            ...
                            Dialog ss= new AlertDialog.Builder(getContext())
                                    ...
                                    .setPositiveButton("Continue", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            Cursor getcdvv= fdbvv.query("S1",namevv,"id=?",asdvv,null,null,null);
        ...
        dfgf.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if(event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    newnames=newname.getText().toString().trim();
                    newrooms=newroom.getText().toString().trim();
                    ...
                    if(isOnline()) {if(!newnames.equals("")&&!newrooms.equals("")&&!newinfos.equals("")){
                        if (!newnames.equals(jakalg[0]) || !newrooms.equals(jakalg[1]) || !newnewcol.equals(jakalg[2]) || !newinfos.equals(jakalg[3])){
                            ...
                            Dialog sffs= new AlertDialog.Builder(getContext())
                                    .setTitle("Do you want the same change for Economics ?")
                                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            SharedPreferences pref2 = getActivity().getSharedPreferences("request_id", MODE_PRIVATE);
                                            String request_id_shared = pref2.getString("request_id", "0");
                                            ...
                                            childRefrrf.setValue( new updateinformation(gotitt,newnames,newrooms,newnewcol,newinfos,username,"S2",request_id_shared_1));
                                            DatabaseReference childRefroorf = myRefrrf.push();
                                            childRefroorf.setValue( new updateinformation(gotitt,newnames,newrooms,newnewcol,newinfos,username,"S1",request_id_shared_11));
                                    ...
                                    .setNegativeButton("No", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            childReff.setValue( new updateinformation(gotitt,newnames,newrooms,newnewcol,newinfos,username,"S2",request_id_shared_1));
                                            Intent jhjh= new Intent(getContext(),Main3Activity.class);
                                            getContext().startActivity(jhjh);
                                        }
                                    })
        ...
        Dialog Dialogss = new AlertDialog.Builder(getContext())
                ...
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        DatabaseReference childRefuirf = myReff.push();
                        childRefuirf.setValue( new updateinformation(gotitt,jakalg[0],"",newcolord,"Cancelled",username,"S2",request_id_shared_11));
        ...
        getView().setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if (event.getAction() == KeyEvent.ACTION_UP && keyCode == KeyEvent.KEYCODE_BACK){
                    ...
                    FragmentManager juiodp=getActivity().getSupportFragmentManager();
                    Fragment jjv=juiodp.findFragmentById(R.id.fragmentrr);

                    if(jjv instanceof content_main){
                        getActivity().finish();
    ...
    public void dialogno(){
        ...
        childReff.setValue( new updateinformation(gotitt,  jakalg[0],  "", newcolord, "Cancelled",username,"S2",request_id_shared_1));
        Toast.makeText(getContext(), "Successfully updated", Toast.LENGTH_SHORT).show();
        Intent jhjh= new Intent(getContext(),Main3Activity.class);
        getContext().startActivity(jhjh);
    }
